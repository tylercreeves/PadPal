...
const double OnTime = 120;        //OnTime is the time the inflator will stay on in seconds.
const double DutyCycle = 20;      //Max fan speed in terms of percentage. EX: if DutyCycle = 35, then fan will max out at 35% speed. WARNING, depending on motor installed, DutyCycle >= 45 may cause overheating and damage
